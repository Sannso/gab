/* empty css                                */
import { c as createComponent, a as createAstro, m as maybeRenderHead, b as addAttribute, e as renderTemplate, f as renderComponent } from '../chunks/astro/server_CPg43tOk.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                                 */
...
const astroLogo = new Proxy({"src":"/_astro/astro.Dm8K3lV8.svg","width":115,"height":48,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/programacion/Sanss/GAB/gab/src/assets/astro.svg";
							}
...
const background = new Proxy({"src":"/_astro/background.BPKAcmfN.svg","width":1440,"height":1024,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "E:/programacion/Sanss/GAB/gab/src/assets/background.svg";
							}
...
}, "E:/programacion/Sanss/GAB/gab/src/components/Welcome.astro", void 0);
...
}, "E:/programacion/Sanss/GAB/gab/src/pages/index.astro", void 0);

const $$file = "E:/programacion/Sanss/GAB/gab/src/pages/index.astro";
const $$url = "";
